...
poi_land_parcel = gls[['land_parcel_id',
                       'land_parcel_std',
                       'latitude',
                       'longitude']].drop_duplicates(subset='land_parcel_id').reset_index(drop=True)


# execute function
mrt_distance = calculate_distance(poi_land_parcel, 'land_parcel_id', poi_mrt, 'poi_name', distance_limit=5000)
bus_distance = calculate_distance(poi_land_parcel, 'land_parcel_id', poi_bus, 'poi_name', distance_limit=5000)
sch_distance = calculate_distance(poi_land_parcel, 'land_parcel_id', poi_sch, 'poi_name', distance_limit=5000)
check = 42
