...
def find_comparable_price(comparable_df, dat, index_table, price_col):
    try:
        ...
        comparable_df['base_hi'] = index_table[index_table.year_launch == dat.year_launch.values[0]].hi_price_psm_gfa.values[0]
        comparable_df['hi_price_psf'] = comparable_df[price_col]/comparable_df.hi_price_psm_gfa * comparable_df.base_hi
